...
<html>
    <head>
        ...
        <script type="text/javascript"
                src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6d8973dcf3b197a7756d28406c03fd2e"></script>
    </head>
    <body>
    <section>
        <script>
            $(function () {
                $("#sBtn").click(function () {
                    ...
                    $.ajax({
                        url: "public_data2",
                        type: "post",
                        data: {"keyword": $("#keyword").val()}, // controller 로 keyword 변수값을 전달
                        dataType: "json",
                        success: function (data) {
                            ...
                            for (let i = 0; i < arr.length; i++) {
                                ...
                                htmlData += '<td>';
                                htmlData += '<img style="width: 30%"src="' + arr[i].galWebImageUrl + '">';
                                htmlData += '</td>';
                                htmlData += '</tr>';
